...
import a1 from "../../../pdfs/brochures/Folklore is....pdf";
import a2 from "../../../pdfs/brochures/Ghost Stories @ Fultz House.pdf";
import a3 from "../../../pdfs/brochures/Ghostly Encounters.pdf";
import a4 from "../../../pdfs/brochures/Ghostly Goings-On.pdf";
import a5 from "../../../pdfs/brochures/Ghostly Tales.pdf";
import a6 from "../../../pdfs/brochures/The History and Folklore of Holidays in Nova Scotia.pdf";
import a7 from "../../../pdfs/brochures/Weather Lore for All Seasons.pdf";
            ...
            <div className="flex-row">
                ...
                <div className="flex-item">
                    ...
                    <p className="card-text">
                        Every culture has different historical backgrounds and traditions resulting in many versions of folklore. See what we came up with, and why we think it is pretty cool and amazing.
                    </p>
                    <a href={a1} className="card-link" target="_blank">Read more</a>
                </div>
                ...
                <div className="flex-item">
                    ...
                    <a href={a2} className="card-link" target="_blank">Read more</a>
                </div>
                ...
                <div className="flex-item">
                    ...
                    <a href={a3} className="card-link" target="_blank">Read more</a>
                </div>
                ...
                <div className="flex-item">
                    ...
                    <a href={a4} className="card-link" target="_blank">Read more</a>
                </div>
                ...
                <div className="flex-item">
                    ...
                    <a href={a5} className="card-link" target="_blank">Read more</a>
                </div>
                ...
                <div className="flex-item">
                    ...
                    <a href={a6} className="card-link" target="_blank">Read more</a>
                </div>
                ...
                <div className="flex-item">
                    ...
                    <a href={a7} className="card-link" target="_blank">Read more</a>
                </div>
